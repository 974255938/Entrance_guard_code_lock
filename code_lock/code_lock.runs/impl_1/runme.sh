...
HD_PWD='C:/Users/yqy/Desktop/project/code_lock/code_lock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log code_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source code_lock.tcl -notrace
