...
HD_PWD='C:/Users/yqy/Desktop/project/code_lock/code_lock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log code_lock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source code_lock.tcl
